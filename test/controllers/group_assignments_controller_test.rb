...
class GroupAssignmentsControllerTest < ActionController::TestCase
  ...
  test "should create group_assignment" do
    assert_difference('GroupAssignment.count') do
      post :create, group_assignment: { assign_date: @group_assignment.assign_date, group: @group_assignment.group, user: @group_assignment.user }
    end
  ...
  test "should update group_assignment" do
    patch :update, id: @group_assignment, group_assignment: { assign_date: @group_assignment.assign_date, group: @group_assignment.group, user: @group_assignment.user }
    assert_redirected_to group_assignment_path(assigns(:group_assignment))
  end
